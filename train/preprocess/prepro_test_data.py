...
def createNPZ_test(params):
	...
	im_set = np.zeros((10000, 256, 256, 3), dtype=np.uint8)
	...
	np.savez('%s_%d_%s.npz' %(params['name'], params['img_resize'], params['split']), im_set)
